...
final class Templates {
	...
	private static function shop_archive(): TemplateSpec {
		...
		$sidebar->add_child( new RawNode( RawNode::raw_widget( 'fibosearch', array(), 'wc_sidebar_search' ) ) );
		$sidebar->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-product-categories', array(), 'wc_sidebar_cats' ) ) );
		$sidebar->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-price-filter', array(), 'wc_sidebar_price' ) ) );
		...
		$pagination_row->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-archive-products', array(), 'wc_archive_pagination' ) ) );
	...
	private static function single_product(): TemplateSpec {
		...
		$breadcrumbs->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-breadcrumb', array(), 'wc_breadcrumbs' ) ) );
		...
		$images_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-product-images', array(), 'wc_product_images' ) ) );
		$row->add_child( $images_col );

		$info_col = new Container( array( 'content_width' => 'boxed', '_flex_size' => '0 0 50%' ) );
		$info_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-product-title', array(), 'wc_product_title' ) ) );
		$info_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-product-price', array(), 'wc_product_price' ) ) );
		$info_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-product-rating', array(), 'wc_product_rating' ) ) );
		$info_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-product-short-description', array(), 'wc_product_short_desc' ) ) );
		$info_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-product-add-to-cart', array(), 'wc_product_add_to_cart' ) ) );
		$info_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-product-meta', array(), 'wc_product_meta' ) ) );
		$row->add_child( $info_col );
		$doc->append( $row );

		// Tabs row.
		$tabs = new Container( array( 'content_width' => 'boxed' ) );
		$tabs->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-product-data-tabs', array(), 'wc_product_tabs' ) ) );
		$doc->append( $tabs );

		// Related products.
		$related = new Container( array( 'content_width' => 'boxed' ) );
		$related->add_child( Heading::create( 'Related products', 'h3', 'left' ) );
		$related->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-product-related', array( 'columns' => 4 ), 'wc_product_related' ) ) );
		$doc->append( $related );
	...
	private static function cart(): TemplateSpec {
		...
		$items_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-cart', array( 'section' => 'cart_table' ), 'wc_cart_items' ) ) );
		$items_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-cart', array( 'section' => 'coupon' ), 'wc_cart_coupon' ) ) );
		...
		$totals_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-cart', array( 'section' => 'cart_totals' ), 'wc_cart_totals' ) ) );
	...
	private static function checkout(): TemplateSpec {
		...
		$form_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-checkout-page', array( 'section' => 'billing' ), 'wc_checkout_billing' ) ) );
		$form_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-checkout-page', array( 'section' => 'shipping' ), 'wc_checkout_shipping' ) ) );
		...
		$review_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-checkout-page', array( 'section' => 'order_review' ), 'wc_checkout_review' ) ) );
		$review_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-checkout-page', array( 'section' => 'payment' ), 'wc_checkout_payment' ) ) );
		$review_col->add_child( new RawNode( RawNode::raw_widget( 'woocommerce-checkout-page', array( 'section' => 'place_order' ), 'wc_checkout_place_order' ) ) );
